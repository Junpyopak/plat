...
public class Enemy : MonoBehaviour
{
    ...
    CapsuleCollider2D groundCheck; //enemy에 설정된 캡슐 콜라이더로 땅을 밟고있는지 확인을 위함
    ...
    {
        if(groundCheck.IsTouchingLayers(LayerMask.GetMask("Ground"))==true)//enemy에 설정된 캡슐 콜라이더로 땅을 밟고 있으면서
